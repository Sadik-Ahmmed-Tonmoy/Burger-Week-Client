...
const Banner = () => {
  return (
    <div id="home" className="my-auto pt-32 md:pt-0"  style={{ backgroundImage: `url('${bgImg}')` }}>
     <div className="md:flex md:justify-around">
     <div className="p-4 md:ms-5 flex flex-col justify-center">
      ...
      <div className=" relative">
        ...
        <div className="absolute bottom-24 left-28 md:bottom-48 md:left-52">
          <div className="relative">
